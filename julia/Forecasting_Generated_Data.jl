...
savefig("../Figures/WithGenerated/OLSPrediction.pdf")
#############################################################
"""
...
plot!(ŷ,label="ŷ")
plot!(yfull[J+h:end],label="actual data")
savefig("../Figures/WithGenerated/ModelAveragingPrediction.pdf")
#############################################################
"""
...
plot!(ŷ,label="ŷ")
plot!(yfull[J+h:end],label="actual data")
savefig("../Figures/WithGenerated/RidgePrediction.pdf")
"""
...
savefig("../Figures/WithGenerated/BayesianMAPrediction.pdf")
